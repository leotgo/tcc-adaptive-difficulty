...
% Avg Adjustment Target per Level - Beginner Players
% =======================
\begin{figure}[!ht]
...
% Avg Attack Avoidance Efficiency per Level - Beginner Players
% =======================
\begin{figure}[!ht]
...
% Avg Attack Window Efficiency per Level - Beginner Players
% =======================
\begin{figure}[!ht]
...
%completion_time
% Avg Completion Time per Level - Beginner Players
% =======================
\begin{figure}[!ht]
...
% Avg Damage Dealt per 10s per Level - Beginner Players
% =======================
\begin{figure}[!ht]
...
%deaths_per_level
% Avg Deaths per Level - Beginner Players
% =======================
\begin{figure}[!ht]
...
% Avg Health Lost per Encounter per Level - Beginner Players
% =======================
\begin{figure}[!ht]
...
%adjustment_target_level
% Avg Adjustment Target per Level - Intermediate Players
% =======================
\begin{figure}[!ht]
...
%attack_avoidance_efficiency
% Avg Attack Avoidance Efficiency per Level - Intermediate Players
% =======================
\begin{figure}[!ht]
...
%attack_window_efficiency
% Avg Attack Window Efficiency per Level - Intermediate Players
% =======================
\begin{figure}[!ht]
...
%completion_time
% Avg Completion Time per Level - Intermediate Players
% =======================
\begin{figure}[!ht]
...
%damage_dealt_per_10s
% Avg Damage Dealt per 10s per Level - Intermediate Players
% =======================
\begin{figure}[!ht]
...
%deaths_per_level
% Avg Deaths per Level - Intermediate Players
% =======================
\begin{figure}[!ht]
...
%health_lost_per_encounter
% Avg Health Lost per Encounter per Level - Intermediate Players
% =======================
\begin{figure}[!ht]
...
%adjustment_target_level
% Avg Adjustment Target per Level - Veteran Players
% =======================
\begin{figure}[!ht]
...
%attack_avoidance_efficiency
% Avg Attack Avoidance Efficiency per Level - Veteran Players
% =======================
\begin{figure}[!ht]
...
%attack_window_efficiency
% Avg Attack Window Efficiency per Level - Veteran Players
% =======================
\begin{figure}[!ht]
...
%completion_time
% Avg Completion Time per Level - Veteran Players
% =======================
\begin{figure}[!ht]
...
%damage_dealt_per_10s
% Avg Damage Dealt per 10s per Level - Veteran Players
% =======================
\begin{figure}[!ht]
...
%deaths_per_level
% Avg Deaths per Level - Veteran Players
% =======================
\begin{figure}[!ht]
...
%health_lost_per_encounter
% Avg Health Lost per Encounter per Level - Veteran Players
% =======================
\begin{figure}[!ht]
