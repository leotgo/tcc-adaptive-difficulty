...
\begin{table}[!ht]
    \begin{center}
      ...
      \begin{tabular}{ w{c}{6em} m{27em} } % alignments and column size
        ...
        \makecell[c]{Damage Dealt\\per 10 seconds} & The average amount of damage dealt by a player for every 10 seconds of combat, with value $v \in \mathbb{R}$ and measured in health points, during the combat encounters at a given level. Combat encounters start when the first enemy i a group engages the player and is able to attack, and ends when the last enemy of the group is defeated. \\
...
\begin{table}
    \begin{center}
      ...
      \rowcolors{2}{}{gray!25} % Alternate row colors
      \begin{tabular}{ w{c}{9em} w{c}{5em} m{17em} } % alignments and column size
        \addlinespace
        \toprule
        % Headings
        ...
        \midrule
        % Data
        \makecell[c]{I think the gameplay\\was satisfying} & Aesthetics & Evaluate if the gameplay is sufficiently satisfactory to players. \\
        \makecell[c]{I think the graphics\\were visually appealing} & Aesthetics & Evaluate if the visuals are sufficiently appealing to players. \\
        \makecell[c]{I think the sounds\\provided proper\\feedback to actions} & Aesthetics & Evaluate if the audio harmonizes with the visuals and actions performed by players. \\
        \makecell[c]{I felt interested\\to the game} & Aesthetics & Evaluate if users were motivated to play the game during the experiment. \\
        \makecell[c]{I think the game was\\hard to understand} & Learning & Evaluate if users had issues understanding basic game elements.  \\
        \makecell[c]{I think the game\\was easy to play} & Learning & Evaluate if users had ease with executing basic game mechanics.  \\
        \makecell[c]{I think the game\\was easy to learn} & Learning & Evaluate if users had ease with learning how to play. \\
        \makecell[c]{I think the game\\was difficult} & Difficulty & Evaluate if users perceived the game as generally difficult to complete. \\
        \makecell[c]{I think the difficulty\\was unfair} & Difficulty & Evaluate if the game presented a significantly higher level of challenge in comparison to the skill level of players. \\
        \makecell[c]{I had trouble with\\the game controls} & Usability & Evaluate if players had issues caused by button mapping, basic mechanics or input device compatibility issues. \\
        \makecell[c]{I had trouble\\hitting enemies} & Usability & Evaluate if players had issues caused by failures in the hit detection system. \\
        \makecell[c]{I had trouble defending\\against enemies} & Usability & \\
        \makecell[c]{I had trouble dodging\\enemy attacks} & Usability & \\
        \makecell[c]{I had trouble with\\a specific enemy} & Usability & \\
        \makecell[c]{I had trouble finding\\out where to go} & Usability & \\
        \makecell[c]{I had a hard\\time playing} & Usability & \\
        \bottomrule
      \end{tabular}
    \end{center}
\end{table}
...
\begin{table}
    \begin{center}
      ...
      \rowcolors{2}{}{gray!25} % Alternate row colors
      \begin{tabular}{ w{c}{10em} w{c}{5em} m{17em} } % alignments and column size
        \addlinespace
        \toprule
        % Headings
        \bf Assessment & \bf Category & \bf Objective  \\
        \midrule
        % Data
        \makecell[c]{I think the enemies\\were challenging} & Difficulty & \\
        \makecell[c]{I think the enemies were\\too challenging for me} & Difficulty & \\
        \makecell[c]{I think the enemies\\were too easy for me} & Difficulty & \\
        \makecell[c]{I think the enemies in\\later levels were harder} & Difficulty & \\
        \makecell[c]{I found myself\\constantly outnumbered} & Learning & \\
        \makecell[c]{I learned how to defend\\against enemy attacks} & Learning & \\
        \makecell[c]{I learned how to\\dodge enemy attacks} & Learning & \\
        \makecell[c]{I think the second version\\was easier than the first} & Improvement & \\
        \makecell[c]{I think the second version\\was harder than the first} & Improvement & \\
        \makecell[c]{I think the enemies\\in the second version\\were smarter} & Improvement & \\
        \makecell[c]{I think the enemies\\in the second version\\were dumber} & Improvement & \\
        \makecell[c]{I felt confident in my\\first time playing} & Improvement & \\
        \makecell[c]{I think I did better in\\my second time playing} & Improvement & \\
        \makecell[c]{I felt more confident in\\the second time playing} & Improvement & \\
        \makecell[c]{I felt frustrated\\while playing} & Feeling & \\
        \makecell[c]{I felt anxious\\while playing} & Feeling & \\
        \makecell[c]{I felt bored\\while playing} & Feeling & \\
        \makecell[c]{I felt comfortable\\while playing} & Feeling & \\
        \bottomrule
      \end{tabular}
    \end{center}
\end{table}
