\begin{table}[!ht]
    \begin{center}
      ...
      \begin{tabular}{ >{\small}w{l}{6em} >{\small}w{c}{10em} >{\small}m{16.5em} } % alignments and column size
        \addlinespace
        \toprule
        % Headings
        ...
        \makecell[l]{Attack Avoidance\\Efficiency} & \makecell[c]{Successful \&\\Failed Blocks,\\Dodges,Avoids} & The rate of attacks that are successfully blocked, dodged or avoided in comparison to attacks that hit the player. \\

        \makecell[l]{Obstacle Avoidance} & \makecell[c]{AvailableDodgeArea} & The avg. percentage of the dodge area occupied by walls and obstacles over a Level. \\
        ...
        \makecell[l]{Average Deaths} & \makecell[c]{LevelStart,Death} & Avg. number of times player died over a Session. \\
