...
\section{Telemetry and Performance Tracking (WIP)}
...
- We use three difficulty presets as a base to perform adjustments on. Each preset defines values for all adjustable parameters.

- Figure \ref{fig:dynamic-adjustments-flow} shows the event flow and interactions for the systems involving the adjustments system.
