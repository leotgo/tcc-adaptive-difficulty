...
\begin{table}
    \begin{center}
      ...
      \begin{tabular}{ >{\small}w{l}{4em} m{3.5em} m{20em} } % alignments and column size
        \addlinespace
        \toprule
        % Headings
        ...
        Source         & ObjectId        & The source in-game entity which caused the event to 
                                           be raised.                                          \\
        Params         & \makecell[l]{Array of\\Tuples} & A set of data parameters, given in string format,  
