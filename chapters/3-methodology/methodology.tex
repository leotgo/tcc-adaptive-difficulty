...
% ! (ADDITIONAL) Add formulae to vector dot product between defender and attacker direction, with outcomes.
...
For an AI Agent to perform movement over the environments that were assembled, we make use of the \emph{NavMesh} system, which uses the 3D topology of the environment and a user-defined set of layers with movement costs to generate a simplified mesh. The resulting mesh represents the area that can be traversed by an AI Agent, along with weights for each vertex that causes the AI Agent to prioritize certain paths defined by the user. Using this definition, we define the movement performed by the AI as a set of waypoints that are calculated using the \textsc{A\*} algorithm with the \textsc{Manhattan Distance} heuristic.
...
\subsubsection{Design of Enemy Types}
...
% =========|============|========|===========|=========|==========================================
% Ghoul    | Slowest    | Lowest | Slow      | Lowest  | Meant to be introductory enemy for player
%          |            |        |           |         | to test mechanics.                       
% ---------|------------|--------|-----------|---------|------------------------------------------
% Basic    | Fast       | Low    | Medium    | Low     | Meant to keep player away from archers    
% Skeleton |            |        |           |         | and flee from warriors.                  
% ---------|------------|--------|-----------|---------|------------------------------------------
% Warrior  | Slow       | Medium | Slowest   | High    | Uses shield and is meant to be the last  
% Skeleton |            |        |           |         | killed, hard for the the player to kill.  
% ---------|------------|--------|-----------|---------|------------------------------------------ 
% Archer   | Stationary | Low    | Slowest   | Medium  | Meant to slowly drain player health from
% Skeleton |            |        |           |         | a distance if not prioritized.           
% ---------|------------|--------|-----------|---------|------------------------------------------
% Undead   | Medium     | High   | Fast      | Highest | Meant to force player to dodge, blocking 
% Knight   |            |        |           |         | his Attacks Drain too much Stamina.      
% =========|============|========|===========|=========|==========================================

% Table - Attack Speed Values
%
% ==========|==========|==================
% Atk Speed | Atks per | Entities
%           | Second   |
% ==========|==========|==================
% Slowest   |     0.33 | Archers, Warriors
% Slow      |      0.5 | Ghouls
% Medium    |      0.8 | Basic Skeletons
% Fast      |      1.5 | Knights
% Fastest   |      2.3 | Player
% ==========|==========|==================
...
%
% ========|=========|================
% Health  | Atks to | Entities
%         | Kill    |
% ========|=========|================
% Lowest  |       2 | Ghouls
% Low     |       3 | Basic Skeletons
% Medium  |       6 | Archers
% High    |       8 | Warriors
% Highest |      10 | Knights
% ========|=========|================
...
%
% =======|=============|=========================
% Damage | Atks to     | Entities
%        | Kill Player |
% =======|=============|=========================
% Lowest |          20 | Ghouls
% Low    |          14 | Archers, Basic Skeletons
% Medium |          12 | Warriors
% High   |           9 | Knights
% =======|=============|=========================
...
\subsection{Level Design (ADDITIONAL)}
