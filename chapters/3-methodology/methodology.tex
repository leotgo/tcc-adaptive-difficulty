...
% TODO add reference to AI Brain component subsection
...
% TODO Figure: Figure illustrating the behavior of the "arc segments" algorithm
\input{figures/fig_arc_segments}

% TODO Figure: Enemy typical radial placement around the player character
...
% Attack categories
%     - Default attack: basic values, easy to avoid
%     - Special attacks:
%         - Gap closer attack: good vs walking out
%         - Defense break attack: good vs blocking
%         - Sweep attack: good vs dodging

\subsection{Management of Agent Groups}
\label{sec:ai-brain}

% special attacks have a queue to be executed
% global attack cooldown

% TODO \subsubsection{Design of Enemy Types (ADDITIONAL)}
